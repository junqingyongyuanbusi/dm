...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_messages_chatwoot_message_id"), "messages", ["chatwoot_message_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_outbox_messages_chatwoot_message_id"),
        "outbox_messages",
        ["chatwoot_message_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_outbox_messages_platform_message_id"),
        "outbox_messages",
        ["platform_message_id"],
        unique=False,
    )
